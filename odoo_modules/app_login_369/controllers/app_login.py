...
class AppLogin(http.Controller):
    ...
    def _dial_of(self, country_id):
        """Dial code for a country the app picked, or '91' when it sent none.
        ...
        return str(country.phone_code) if country.exists() and country.phone_code else '91'
    ...
    def start(self, **params):
        ...
        if user:
            ...
            user._app_login_remember_country(params.get('country_id'))
        ...
        sent = self._send_code(
            normalize_msisdn(digits, self._dial_of(params.get('country_id'))),
            code, 'signup')
